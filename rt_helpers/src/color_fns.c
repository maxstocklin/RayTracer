...
/*   Updated: 2023/05/03 16:08:53 by srapopor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rgb	add_light(t_rgb color1, t_rgb color2, double intensity)
{
	...
	res.red = (int)(((double)color1.red * ((double)color2.red) * intensity) \
		/ (double)255);
	res.green = (int)(((double)color1.green * ((double)color2.green) \
		* intensity) / (double)255);
	res.blue = (int)(((double)color1.blue * ((double)color2.blue) * \
		intensity) / (double)255);
	return (res);
}
